            ...
            for w in weights: 
                for tim in times:
                    ...
                    for j in range(5):
                        ...
                        xtst = np.arange(x_min, x_max, 0.005)
                        plt.figure()
                        plt.title("predicted c(r,t) function for lambda=" + str(w) + ", iteration: " + str(j+1) + ", time:" + str(tim))
                        ...
                        np.savetxt("data_"+str(radius0)+"_"+str(radius2)+"_"+str(w)+'_'+str(j+1)+'_'+str(tim)+".csv" , dataset, delimiter = ",")
                        ...
                        plt.legend()
                        plt.savefig('lambda_' + str(radius0) + "_" + str(radius2) + '_' + str(w) + '_' + str(j+1) + '_' + str(tim) +'.png')
